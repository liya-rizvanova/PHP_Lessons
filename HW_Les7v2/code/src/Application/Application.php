...
namespace HW_Les7v2\Application;

use HW_Les7v2\Domain\Controllers\AbstractController;
use HW_Les7v2\Infrastructure\Config;
use HW_Les7v2\Infrastructure\Storage;
use HW_Les7v2\Application\Auth;

class Application
{

    private const APP_NAMESPACE = 'HW_Les7v2\Domain\Controllers\\';
