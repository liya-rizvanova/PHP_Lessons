...
namespace HW_Les8\Application;

use HW_Les8\Domain\Controllers\AbstractController;
use HW_Les8\Infrastructure\Config;
use HW_Les8\Infrastructure\Storage;
use HW_Les8\Application\Auth;

class Application
{

    private const APP_NAMESPACE = 'HW_Les8\Domain\Controllers\\';
